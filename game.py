...
class Game:
    def __init__(self):
        ...
        self.background_sfx = pygame.mixer.Sound("assets/sfx/background.mp3")
    ...
    def check_player_coin_collisions(self):
        ...
        for coin in self.coins:
            if coin.rect.colliderect(self.player.rect):
                ...
                # plays a sound when the player collects a coin
    ...
    def draw(self):
        ...
        if not self.game_over:
            # stop player death sound when we start the game again
